...
# 设置训练相关参数
tf.app.flags.DEFINE_integer("lstm_hidden_units", 64, "hidden neural lstm cell numbers")
...
tf.app.flags.DEFINE_integer("epoch", 100, "Iterations to train [1e4]")
...
tf.app.flags.DEFINE_float("learning_rate_delay", 0.9, "learning rate delay")
